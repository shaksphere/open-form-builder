 ...
 * Description:       A CF7-style form builder with multi-step wizards, conditional logic, a capacity-aware session picker, a pricing-rules engine, Stripe Checkout, conditional emails, Google Sheet export and CF7 import. Forms are declarative JSON schemas.
 * Version:           0.2.1
